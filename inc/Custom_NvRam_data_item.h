...
LID_BIT VER_LID(AP_CFG_RDCL_FILE_TN_LID)
TN_STRING_STRUCT *CFG_FILE_TN_REC_TOTAL
{
 ...
 *
 */
LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_BATTERY_LID)
File_CUSTOM_BATTERY_Struct *CFG_FILE_CUSTOM_BATTERY_REC_TOTAL
{
