...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_CUSTOM_FILE_CUSTOM1_LID,
    AP_CFG_RDCL_FILE_TN_LID,
    /**
     *  Add one lid in the enum definition of "CSUTOM_CFG_FILE_LID" 
     *  The newest lis must add at the end of hte definition table .(before MAX_LID)
     *  define the version number of NvRam file
     */
    AP_CFG_CUSTOM_FILE_BATTERY_LID,
...
/*  Custom_Battery Version  */
#define AP_CFG_CUSTOM_FILE_BATTERY_LID_VERNO			"000"
...
/*added by suxn for auto test*/
#define AP_CFG_RDCL_FILE_TN_LID_VERNO     "000"
