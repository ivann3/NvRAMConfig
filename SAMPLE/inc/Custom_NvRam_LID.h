...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_RDCL_FILE_MASSCOM_WARRANTY_LID,
	AP_CFG_CUSTOM_FILE_CUSTOM1_LID,
	//在这里加入你自己用于记录的项，名称自取，最好参照这个格式。添加的项一定要紧挨 AP_CFG_CUSTOM_FILE_MAX_LID之上，不然会导致上面的内容出错。
	//因为这个数据是从0开始依次递增的，你并不知道为多少。详见应用层NvRAM读写。
	AP_CFG_XXXX_FILE_XXXX_LID,
...
//这里注明版本为“000”
#define AP_CFG_XXXX_FILE_XXXX_LID_VERNO			"000"
...
#define AP_CFG_RDCL_FILE_MASSCOM_WARRANTY_LID_VERNO   "000"
