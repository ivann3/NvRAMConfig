...
LID_BIT VER_LID(AP_CFG_RDCL_FILE_MASSCOM_WARRANTY_LID)
MASSCOM_WARRANTY_CFG_Struct *CFG_FILE_MASSCOM_WARRANTY_REC_TOTAL
{
...
LID_BIT VER_LID(AP_CFG_XXXX_FILE_XXXX_LID)//这里是你加入Custom_NvRam_LID.h中的项。
File_XXXX_Struct *CFG_FILE_CUSTOM1_REC_TOTAL//这里是在CFG_Custom1_File.h中定义的类容
{
